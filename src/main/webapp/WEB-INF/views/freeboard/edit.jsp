	...
	<main id="container">
		...
		<div class="content">
			<div class="content_inner">
				<h2>글 수정하기</h2>
				<form id="editForm" name="editForm" method="post" action="/freeboard/editPost.do">
					...
					<!-- 버튼 -->
					<div class="btn_wrap">
						<a class="cancel_btn" href="/freeboard/viewPost.do?board_idx=${ boardDTO.board_idx }"><span>취소</span></a>
